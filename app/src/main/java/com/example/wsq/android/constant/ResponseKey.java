...
public class ResponseKey {
    ...
    public static final String NEW_PSD = "newpassword";
    ...
    public static final String SFZ1 = "sfz1";

    public static final String SFZ2 = "sfz2";
    ...
    public static final String CREATE = "baoxiutime";
    ...
    public static final String BAOXIUTIME = "baoxiutime";

    public static final String CHAILV = "chailv";

    public static final String FUWU = "fuwu";

    public static final String BEIJIAN = "beijian";
    ...
    public static final String NOPASS= "nopass_reason";

    public static final String S_NAME = "s_name";

    public static final String S_TEL = "s_tel";

    public static final String R_IMGS = "r_imgs";
    ...
    public static final String YILIU= "yiliu";
